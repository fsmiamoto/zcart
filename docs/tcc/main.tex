...
\keywords{Artificial Inteligence, Deep Learning, Smart Devices, Internet of Things, Sensors} 
...
To feed supervised Deep Learning algorithms to detect multiple objects within an image, we need to provide our AI Models with 
images that have one or more labels within them, the specification on what labels are there, and their coordinates.
...
(\sigla{CNN}{Convolutional Neural Networks}). 
...
Finally, a technique known as the Non-Maximum Supression (\sigla{NMS}{Non-Maximum Supression}) is commonly used to filter the
...
\begin{table}[H]
	...
	\begin{tabular}{c|c|c|c|c|c|c|c|c|c|c}
		...
		TBD Efficientdet\-D0 & Cropping & Transfer Learning & \texttt{0.463} & \texttt{0.632} & \texttt{0.577} & \texttt{0.371} & \texttt{0.413} & \texttt{0.626} & \texttt{0.465} & \texttt{0.440} \\
		TBD Efficientdet\-D1 & Cropping & Transfer Learning & \texttt{0.515} & \texttt{0.659} & \texttt{0.594} & \texttt{0.376} & \texttt{0.532} & \texttt{0.741} & \texttt{0.486} & \texttt{0.440} \\
		TBD Efficientdet\-D2 & Cropping & Transfer Learning & \texttt{0.505} & \texttt{0.684} & \texttt{0.617} & \texttt{0.442} & \texttt{0.604} & \texttt{0.554} & \texttt{0.345} & \texttt{0.580} \\
		TBD Efficientdet\-D0 & Cropping & Whole & \texttt{0.817} & \texttt{0.905} & \texttt{0.897} & \texttt{0.804} & \texttt{0.862} & \texttt{0.620} & \texttt{0.969} & \texttt{0.831} \\
		TBD Efficientdet\-D1 & Cropping & Whole & \texttt{0.805} & \texttt{0.926} & \texttt{0.903} & \texttt{0.800} & \texttt{0.761} & \texttt{0.687} & \texttt{0.950} & \texttt{0.829} \\
		TBD Efficientdet\-D2 & Cropping & Whole & \texttt{0.803} & \texttt{0.930} & \texttt{0.912} & \texttt{0.799} & \texttt{0.814} & \texttt{0.657} & \texttt{0.913} & \texttt{0.832} \\
		\hline 
	\end{tabular}
	\end{adjustbox}
