...
network sockets (ADD CITATION) with established application protocols such as
...
the familiar relational modeling, including \sigla{SQL}{Structure Query Language}, were key factors in choosing
it.
...
Computer (\sigla{SBC}{Single Board Computer}).
...
For developing the User App, we have used web technologies such as HTML, CSS and JavaScript (ADD CITATION) through the 
