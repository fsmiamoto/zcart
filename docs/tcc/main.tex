...
For the mechanical assembly, a foldable utility cart was selected as a core
...
As discussed in Section \ref{sec:TPU},

\chapter{Results}

In this section, we discuss the results of the developed prototype.
