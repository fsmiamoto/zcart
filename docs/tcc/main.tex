...
to observer the total power required by the power adapter used to supply energy
...
This work has show the development of \textit{zCart}, a smart cart prototype
using computer vision and sensorial data.
