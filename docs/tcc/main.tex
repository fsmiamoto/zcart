...
We decided to use Google's TensorFlow (include reference TB) framework to train our models, 
as it is one of the most popular frameworks employed in the Industry for training AI models
and also because it features a lightweight library called TensorFlow Lite, which is appropriate
for creating efficient edge and mobile AI models considering the typical hardware constraints
...
TBD describe the EfficientDet architecture.
...
structure:
(TBD include a pretty formatted CSV file https://cloud.google.com/vision/automl/object-detection/docs/csv-format)
